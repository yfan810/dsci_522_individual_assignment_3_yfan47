...
![Horse populations for all provinces in Canada from 1906 to 1972.](../results/horse_pops_plot.png){#fig-horse_pops_plot width=70%}

We can see from @fig-horse_pops_plot that Ontario, Saskatchewan and Alberta have had the highest horse populations in Canada. 
